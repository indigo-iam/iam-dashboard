...
export function Link(props: Readonly<LinkProps>) {
  ...
  return (
    <NextLink
      className="text- text-secondary flex items-center gap-1 rounded-lg p-2 text-base transition ease-in-out hover:bg-white/10 data-[selected=true]:bg-white/10"
      href={href}
