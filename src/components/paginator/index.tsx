...
export default function Paginator(props: Readonly<PaginatorProps>) {
  ...
  const buttonStyle =
    "flex p-0.5 ml-0 bg-white text-primary/50 border border-primary/10 hover:bg-primary/10 dark:bg-secondary/50 dark:text-secondary dark:hover:text-primary dark:hover:bg-white/70";
